...
class PGPToolMainWindow:
    ...
    def run(self):
        ...
        self.refresh_key_list()
        self.refresh_contacts_list()
        self.refresh_chat_profiles()  # Initialize chat profiles dropdown
    ...
    def update_group_display(self):
        ...
        if group_info:
            ...
            creator = group_info.get('creator', 'Unknown')
    ...
    def refresh_chat_profiles(self):
        """Refresh the chat profiles dropdown with available key pairs"""
        try:
    ...
    def on_chat_profile_changed(self, event=None):
        """Handle chat profile selection change"""
        try:
